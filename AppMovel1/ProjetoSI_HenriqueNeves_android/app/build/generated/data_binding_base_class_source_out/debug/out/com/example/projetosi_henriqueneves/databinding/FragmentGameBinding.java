...
public final class FragmentGameBinding implements ViewBinding {
  ...
  private FragmentGameBinding(@NonNull LinearLayout rootView, @NonNull TextView content,
  ...
  public static FragmentGameBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentGameBinding((LinearLayout) rootView, content, itemNumber);
    }
